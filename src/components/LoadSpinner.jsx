...
return (
  <div className="p-10 rounded-xl relative">
    <svg className=" col-span-5w-12 h-12 animate-spin text-red-500" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
